      ...
      <div align="center">
        <div className="bookTheme">
          ...
          <i>
            ...
            a movie, <br />
            not necessarily one of my movies, brings a whole set of unique
            experiences, <br />
            but through careful manipulation and good storytelling, <br />
            you can get everybody to clap at the same time, to hopefully laugh
            at the same time, <br />
            and to be afraid at the same time.” - Steven Spielberg, filmmaker
            <br />
            <br />
            <br />
            <br />
